...
❗Подключение npm пакетов для удобной работы в Vite-проекте.
...
💡 Применение сборщика проектов Vite для улучшения качества и производительности кода.

💡 Работа с Node.js: настройка npm-плагинов для оптимизации изображений, автоматической генерации медиа-запросов, добавления вендорных префиксов и удобной работы с препроцессором Sass.

💡 Развёртывание проекта на GitHub Pages с использованием GitHub Actions.
